...
if(WIN32)
    ...
    set(shell_crosscompile "CC=x86_64-w64-mingw32-gcc CXX=x86_64-w64-mingw32-g++ CFLAGS=-mcrtdll=ucrt CXXFLAGS=-mcrtdll=ucrt")
    set(meson_crosscompile "--cross-file ${cmakeroot}/srcs/x86_64-w64-mingw32.txt")
    set(qemu_crosscompile "--cross-prefix=x86_64-w64-mingw32")
...
run_docker("mkdir -p ${cmakeroot}objs/qemu && cd ${cmakeroot}objs/qemu && ${shell_crosscompile} PKG_CONFIG_PATH=${cmakeroot}libs/lib/pkgconfig ${cmakeroot}srcs/qemu/configure --target=x86_64-w64-mingw32 --enable-whpx --enable-system --enable-slirp --enable-vnc --target-list=aarch64-softmmu,arm-softmmu,avr-softmmu,riscv32-softmmu,riscv64-softmmu,x86_64-softmmu --prefix=c:/dist --disable-gio --disable-curl --disable-zstd --disable-bzip2 --disable-curses --static --extra-ldflags=-liconv --disable-werror --extra-cflags=-DLIBSLIRP_STATIC ${qemu_crosscompile}")
